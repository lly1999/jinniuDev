<template>
    <el-container class="container">
        ...
        <Header @back="goback">
            ...
            <!-- 子系统名字 -->
            <template #content>
                <span class="content" style="font-size:25px">广告招牌二维码管家</span>
            </template>
            <!-- 用户信息 -->
            <template #userinfo>
                <el-dropdown>
            ...
            <el-aside>
                <el-menu class="menu">
                    ...
                    <template v-for="(item, idx) in menuList">
                        <template v-if="item.submenu.length != 0">
                            <el-sub-menu :index="idx+''" :key="idx">
                                ...
                                <el-menu-item v-for="(subitem, subidx) in item.submenu" :index="idx+'-'+subidx"
                                    :key="subidx" @click="displayContent(subitem.to)">
                                    <el-icon>
                    ...
                    <el-menu-item>
                        ...
                        <span style="font-size:25px"><a href="http://175.153.176.27:18802/api/login/c2luZ2xlTG9naW46c2luZ2xlTG9naW4="
                                target="_blank">跳转主页</a></span>
                    </el-menu-item>
                </el-menu>
            </el-aside>
            <el-main>
...
onMounted(() => router.push('/ggzp/xjry'))
...
// 这个应该从后台请求获得
const menuList = [
    { icon: 'House', title: '巡检人员', to: 'xjry', submenu: [] },
    { icon: 'House', title: '巡查管理', to: 'xcgl', submenu: [{ icon: 'Setting', title: '巡查记录', to: 'xcgl' },] },
